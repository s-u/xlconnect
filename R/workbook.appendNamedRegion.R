...
setGeneric("appendNamedRegion",
	function(object, data, name, header = FALSE, rownames = NULL, worksheetName = .jnull(class = "java/lang/String")) standardGeneric("appendNamedRegion"))

setMethod("appendNamedRegion", 
	signature(object = "workbook", data = "ANY"), 
	function(object, data, name, header = FALSE, rownames = NULL, worksheetName = .jnull(class = "java/lang/String")) {
		...
		xlcCall(object, "appendNamedRegion", data, name, worksheetName, header, .simplify = FALSE)
		invisible()
	}
)
